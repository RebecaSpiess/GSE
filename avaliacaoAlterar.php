					...
					<div class="card-body">
						...
						obrigatório!</div>
								...
								<label for="conteudoAvaliacao">Conteúdo*</label> 
									<textarea rows="10" cols="30" style="width: 100%; max-width:100%;border: 1px solid #ced4da" maxlength="5000" id="conteudoAvaliacao" name="conteudoAvaliacao" placeholder="Conteudo cobrado na avaliação"> <?php echo $db_turma_fetch[0]['DESCRICAO'];?></textarea>
									<div id="assuntoErro"
						style="display: none; font-size: 10pt; color: red">Campo
						obrigatório!</div>
								</div>
